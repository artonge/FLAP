...
<div id="mailcontent" class="container section">
  ...
  <div class="card">
    ...
    <TMPL_IF NAME="CHOICE_VALUE">
      <input type="hidden" id="authKey" name="<TMPL_VAR NAME="CHOICE_PARAM">" value="<TMPL_VAR NAME="CHOICE_VALUE">" />
		...
		<TMPL_IF NAME=DISPLAY_LOGIN_INPUT>
  ...
  <div class="card">
    ...
    <div class="form">
      ...
      <div class="input-group mb-3 flapskin-hide">
        <div class="input-group-prepend" style="margin-top: 6px;">
          <div class="input-group-text">
            <input class="form-check-input" id="resendconfirmation" type="checkbox" checked name="resendconfirmation" ariadescribedby="resendconfirmationlabel">
          </div>
        </div>
  ...
  <div class="card">
	...
	<div class="buttons">
	  <a href="<TMPL_VAR NAME="PORTAL_URL">?skin=<TMPL_VAR NAME="SKIN"><TMPL_IF NAME="CHOICE_VALUE">&<TMPL_VAR NAME="CHOICE_PARAM">=<TMPL_VAR NAME="CHOICE_VALUE"></TMPL_IF><TMPL_IF NAME="AUTH_URL">&url=<TMPL_VAR NAME="AUTH_URL"></TMPL_IF>" class="btn btn-primary gray-medium no-outline small" role="button">
