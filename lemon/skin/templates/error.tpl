...
<div id="errorcontent" class="container section">
  ...
  <div class="full-width-forms col-1-2 feed-card bg-white no-first-last flapskin-center">
    ...
    <div id="error">
      ...
      <div class="buttons">
        ...
        <a href="<TMPL_VAR NAME="PORTAL_URL">?cancel=1&skin=<TMPL_VAR NAME="SKIN"><TMPL_IF NAME="AUTH_URL">&url=<TMPL_VAR NAME="AUTH_URL"></TMPL_IF>" class="btn gray-medium no-outline small" role="button">
