...
<head>
 <title trspan="authPortal">FLAP</title>
 ...
 <link rel="stylesheet" type="text/css" href="<TMPL_VAR NAME="STATIC_PREFIX">bwr/vital.min.css" />
 <link rel="stylesheet" type="text/css" href="/lemon_flapskin/css/skin.css" />
